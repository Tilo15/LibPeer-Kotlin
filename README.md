...
* work in progress means work in progress! * this library currently has interoperability issues with the reference implementation; LibPeer-Python.
...
- [ ] Interfaces
  - [x] DSI
  - [ ] OMI
  - [x] SODI NB: potential interoperability issues to be investigated
